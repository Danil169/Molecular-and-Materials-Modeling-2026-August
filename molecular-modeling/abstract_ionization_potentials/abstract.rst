...
Next group of are ab-inition calculations based on ECP-SCF single determinant wave-function. 
ECP corresponds to DK scalar relativistic method of the reference paper.
...
Similarly PySCF code  gives ECP-UHF-CCSD(T) value  10.125 eV  in the def2-tzvp basis set. 
